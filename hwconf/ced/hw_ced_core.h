...
#ifndef HW_CED_CORE_H_
#define HW_CED_CORE_H_

#ifdef HW_CED_IS_MK1
#define HW_NAME "CanEduDev"
#else
...
#define MCCONF_FOC_DT_US (HW_DEAD_TIME_NSEC / 1000)
...
// UART Peripheral. We have permanent UART on SD3, so we use SD2 on port D for
// the UART which doesn't exist on the board. The reason is the firmware
// requires these defines to be present.
...
#define MCCONF_L_MAX_ABS_CURRENT                                               \
  150.0 // The maximum absolute current above which a fault is generated
#endif
